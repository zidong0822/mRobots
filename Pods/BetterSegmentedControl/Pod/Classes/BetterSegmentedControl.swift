...
@IBDesignable public class BetterSegmentedControl: UIControl {
    ...
    public var titles: [String] {
        ...
        set {
            ...
            let labels: [(UILabel, UILabel)] = newValue.map {
                ...
                selectedTitleLabel.font = UIFont.boldSystemFontOfSize(18)
    ...
    @IBInspectable public var indicatorViewInset: CGFloat = 0.0 {
    ...
    public init(frame: CGRect,
        ...
        self.titles = titles
        self.titleFont = UIFont.boldSystemFontOfSize(24)
